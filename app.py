...
def get_image_tensor(image_path_or_bytes):
    if isinstance(image_path_or_bytes, str):
        image = cv2.imread(image_path_or_bytes, cv2.IMREAD_GRAYSCALE)  # shape (3056, 2544)
    else:
...
def main():
    ...
    if uploaded_file is not None:
            ...
            image_tensor = get_image_tensor(io.BytesIO(image_bytes))
